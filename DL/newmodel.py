def nmodel(repeattimes, data, method="cos", seed=None):
    import numpy as np
    import torch
    ...
    num_epochs = 50
    log_path = os.path.join(LOG_DIR, f"DL_{data}_{method}_combined_training.txt")
    ...
    with open(log_path, "w") as log_f:
        ...
        for epoch in range(num_epochs):
            ...
            #print(
            #    f"Epoch [{epoch + 1}/{num_epochs}] train loss: {total_loss:.4f}  val acc: {val_acc * 100:.2f}%"
            #)
            log_f.write(
